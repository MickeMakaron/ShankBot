...
namespace GraphicsLayer
{
    namespace Constants
    {
        ...
        const unsigned char TILE_PIXEL_WIDTH = 32;
        const unsigned char TILE_PIXEL_HEIGHT = 32;
        ...
        const unsigned char SPRITE_SHEET_TILE_WIDTH = 12;
        const unsigned char SPRITE_SHEET_TILE_HEIGHT = 12;
        ...
        {
            HP_GRAY = TextColor::HP_GRAY,
            HP_FULL = TextColor::HP_FULL,
            HP_LIGHT_GREEN = TextColor::HP_LIGHT_GREEN,
            HP_YELLOW = TextColor::HP_YELLOW,
            HP_LIGHT_RED = TextColor::HP_LIGHT_RED,
            HP_RED = TextColor::HP_RED,
            HP_DARK_RED = TextColor::HP_DARK_RED,
            ...
            TEXT_CURSOR_CHAT = TextColor::SELECTED_TEXT,
