...
namespace GraphicsLayer
{
    class SpriteInfo
    {
        ...
        public:
            explicit SpriteInfo(const std::list<CatalogContent::SpriteSheet>& spriteSheets);
            const Info& get(unsigned int spriteId) const;

        private:
            void parseSpriteSheets(const std::list<CatalogContent::SpriteSheet>& spriteSheets);
