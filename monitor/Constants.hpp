...
namespace GraphicsLayer
{
    namespace Constants
    {
        ...
        enum class RectColor : int
        {
            ...
            TEXT_CURSOR_CHAT_LOCAL = (int)TextColor::SELECTED_TEXT,
            TEXT_CURSOR_CHAT_NO_LOCAL = Color({159, 159, 245, 255}).packed,
            TOOLTIP_BORDER = HP_BACKGROUND,
            TOOLTIP_FILL = HP_GRAY,
