...
namespace GraphicsLayer
{
    class MiniMap
    {
        ...
        public:
            ...
            sb::tibiaassets::Object::MiniMapColor getColor(unsigned int x, unsigned int y);
        ...
        private:
            ...
            static const std::map<int, sb::tibiaassets::Object::MiniMapColor> RGBA_TO_MINI_MAP_COLOR;
    };
}
